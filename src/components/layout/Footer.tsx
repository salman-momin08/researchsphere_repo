...
export default function Footer() {
  ...
  return (
    <footer className={cn(
      ...
      <div className="container px-4 sm:px-6 lg:px-8 py-6 md:py-8 flex flex-col md:flex-row justify-between items-center">
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          <BookOpenText className="h-5 w-5 text-primary" />
          <span className="text-sm md:text-base font-semibold">ResearchSphere</span>
        </div>
        ...
        <div className="flex space-x-3 sm:space-x-4 mt-4 md:mt-0">
          <Link href="/terms" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-muted-foreground hover:text-primary">
            Terms of Service
          </Link>
          <Link href="/privacy" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-muted-foreground hover:text-primary">
            Privacy Policy
          </Link>
        </div>
      </div>
...
export function TermsPage() {
  return (
    <div className="container py-8 sm:py-12 px-4 md:px-6">
      ...
      <div className="prose prose-sm sm:prose-base max-w-none text-muted-foreground">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">1. Acceptance of Terms</h2>
        <p>By accessing or using ResearchSphere, you agree to be bound by these Terms of Service.</p>
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">2. User Conduct</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">3. Intellectual Property</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">4. Disclaimers</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">5. Limitation of Liability</h2>
    ...
    <div className="container py-8 sm:py-12 px-4 md:px-6">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4">Privacy Policy</h1>
       <div className="prose prose-sm sm:prose-base max-w-none text-muted-foreground">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">1. Information We Collect</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">2. How We Use Your Information</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">3. Data Sharing</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">4. Data Security</h2>
        <p>We implement reasonable security measures to protect your information, but no system is completely secure.</p>
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-2 text-foreground">5. Your Rights</h2>
